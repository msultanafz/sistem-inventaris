...
@section('title', 'Tambah Barang Inventaris Baru - ' . config('app.name', 'Laravel'))
    ...
    <div class="bg-white rounded-xl card-shadow p-6 sm:p-8 border border-gray-100 max-w-2xl mx-auto">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 pb-4 border-b border-gray-200">
            <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-800 flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-0">
                ...
                <span>Tambah Barang Inventaris Baru</span>
            </h1>
            <a href="{{ route('inventory_items.index') }}" class="cancel-button-gradient text-white font-semibold py-2 px-5 rounded-md shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-0.5 flex items-center space-x-2 text-sm sm:text-base">
        ...
        <form action="{{ route('inventory_items.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div class="mb-4 md:mb-0">
                    ...
                    <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('name') border-red-500 @enderror" value="{{ old('name') }}" required autofocus>
                    @error('name')
                ...
                <div class="mb-4 md:mb-0">
                    ...
                    <input type="text" name="code" id="code" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('code') border-red-500 @enderror" value="{{ old('code') }}">
                    @error('code')
                        <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-4 sm:mb-5">
                ...
                <textarea name="description" id="description" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div class="mb-4 md:mb-0">
                    ...
                    <input type="number" name="quantity" id="quantity" min="1" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('quantity') border-red-500 @enderror" value="{{ old('quantity', 1) }}" required>
                    @error('quantity')
                        <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-4 sm:mb-5">
                ...
                <input type="text" name="location" id="location" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('location') border-red-500 @enderror" value="{{ old('location') }}" required>
                @error('location')
                    <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4 sm:mb-5">
                ...
                <input type="date" name="purchase_date" id="purchase_date" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('purchase_date') border-red-500 @enderror" value="{{ old('purchase_date') }}">
                @error('purchase_date')
                    <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-5 sm:mb-6">
                ...
                <textarea name="notes" id="notes" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 sm:py-3 sm:px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-indigo-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                @error('notes')
                    <p class="text-red-500 text-xs italic mt-1 sm:mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                ...
                <a href="{{ route('inventory_items.index') }}" class="cancel-button-gradient text-white font-semibold py-2 px-5 sm:py-3 sm:px-7 rounded-md shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-0.5 text-sm sm:text-base w-full sm:w-auto">
                    Batal
                </a>
            </div>
        </form>
